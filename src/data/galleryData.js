export const galleryItems = [
  ...
  },
  {
    id: 3,
    type: "image",
    title: "Curved Glass Sweets & Mithai Display Counter",
    category: "Sweet Displays",
    location: "Traditional Sweets Shop, Jaipur",
    src: "/gallery/1000201968.jpg",
    desc: "Panoramic curved glass display counter loaded with fresh Indian traditional sweets (Laddoo, Peda, Kalakand, Barfi) with anti-drying humidity control.",
    specs: ["Panoramic Curved Front Glass", "Humidity-Controlled Cooling", "SS 304 Hygiene Trays", "Bright Warm LED Lighting"]
  },
  {
    id: 4,
    type: "image",
  ...
  },
  {
    id: 10,
    type: "image",
    title: "Turnkey Sweets Showroom Interior Project",
    category: "Sweet Displays",
    location: "Kesar Sweets Showroom, Jaipur",
    src: "/gallery/1000202031.jpg",
    desc: "Complete sweet shop interior installation featuring continuous curved glass refrigerated showcases filled with premium Indian mithai.",
    specs: ["Turnkey Showroom Installation", "Continuous Counter Run", "Integrated Cash & Billing Station", "Custom Ceiling & Accent Lighting"]
  },
  {
    id: 11,
    type: "image",
  ...
  },
  {
    id: 13,
    type: "image",
    title: "Single-Door Upright Glass Cake Chiller Cabinet",
    category: "Commercial Chillers",
    location: "Pastry Kitchen, Jaipur",
    src: "/gallery/1000202040.jpg",
    desc: "Vertical single-door glass cabinet chiller designed for vertical cake storage, chilled beverages, and dairy products.",
    specs: ["Upright Space-Saving Design", "Double-Glazed Heated Glass Door", "Adjustable Heavy Wire Shelves", "Forced Air Uniform Cooling"]
  },
  {
    id: 14,
    type: "image",
  ...
  },
  {
    id: 17,
    type: "image",
    title: "Multi-Bin Curved Glass Namkeen & Snacks Counter",
    category: "Sweet Displays",
    location: "Namkeen & Sweets Store, Jaipur",
    src: "/gallery/1000202051.jpg",
    desc: "Custom multi-compartment curved glass counter designed specifically for displaying various types of Indian namkeen, bhujia, and dry snacks.",
    specs: ["12 Partitioned Glass Bins", "Curved Front Protective Glass", "Photo-Printed Lower Branding Base", "Granite Top Service Shelf"]
  },
  {
    id: 18,
    type: "image",
  ...
  },
  {
    id: 20,
    type: "image",
    title: "Double-Door Commercial Glass Chiller ('Cakes Bazaar')",
    category: "Commercial Chillers",
    location: "Cakes Bazaar Outlet, Jaipur",
    src: "/gallery/1000202067.jpg",
    desc: "Heavy-duty double-door vertical glass display chiller for 'Cakes Bazaar', holding fresh milk packets, dairy products, chocolates, and cold beverages.",
    specs: ["Double Vertical Glass Doors", "Custom Store Branding Graphics", "High-Volume Internal Capacity", "Heavy Duty Commercial Compressor"]
  },
  {
    id: 21,
    type: "image",
  ...
  },
  {
    id: 22,
    type: "image",
    title: "SS Kitchen Worktable with Overhead Storage Shelf",
    category: "Custom Fabrication",
    location: "Factory Workshop, Jaipur",
    src: "/gallery/1000202069.jpg",
    desc: "Commercial grade stainless steel kitchen prep table featuring an overhead shelf, two under-shelves, and heavy-gauge steel construction.",
    specs: ["SS 304 Heavy Gauge Steel", "Integrated Overhead Shelf", "Dual Under-Storage Racks", "Vibration Dampened Table Top"]
  },
  {
    id: 23,
    type: "image",
  ...
  },
  {
    id: 24,
    type: "image",
    title: "Complete Traditional Sweets Shop Frontage Setup",
    category: "Sweet Displays",
    location: "Traditional Sweets & Lassi Outlet, Jaipur",
    src: "/gallery/1000202073.jpg",
    desc: "Comprehensive sweets shop installation featuring white curved glass display counters, weighing scale, and front outdoor gulab jamun cooking station.",
    specs: ["Turnkey Shop Frontage Design", "White Curved Glass Mithai Counter", "Lassi & Sweet Storage Setup", "Heavy Duty Stainless Countertop"]
  },
  {
    id: 25,
    type: "image",
    title: "Curved Glass Refrigerated Sweets Counter",
    category: "Sweet Displays",
    location: "Sweet Mart, Jaipur",
    src: "/gallery/1000202074.jpg",
    desc: "Refrigerated stainless steel sweet counter filled with Rasgulla, Gulab Jamun, Cham Cham, Barfi, and Kaju Katli in stainless steel trays.",
    specs: ["Curved Front Glass Profile", "SS 304 Deep Sweet Trays", "Controlled Humidity Chilling", "Top Shelf Dry Snack Storage"]
  },
  {
    id: 26,
    type: "image",
  ...
  },
  {
    id: 32,
    type: "image",
    title: "L-Shape Curved Front Stainless Steel Mithai Counter",
    category: "Sweet Displays",
    location: "Showroom Installation, Jaipur",
    src: "/gallery/1000202100.jpg",
    desc: "L-shaped corner curved front stainless steel sweet display counter setup inside a spacious sweet shop showroom.",
    specs: ["L-Shape Corner Configuration", "Curved Front Glass Profile", "Stainless Steel Base Trim", "Integrated Storage Wall Behind"]
  },
  {
    id: 33,
    type: "image",
    title: "Double Glass Door Upright Commercial Chiller",
    category: "Commercial Chillers",
    location: "Retail Store, Jaipur",
    src: "/gallery/1000202103.jpg",
    desc: "Stainless steel double glass door vertical upright chiller for cakes, chocolate boxes, dairy, and bottled cold drinks.",
    specs: ["Double Glass Upright Doors", "SS 304 Exterior & Interior", "Multi-Tier Heavy Shelving", "Digital Temp Controller with Readout"]
  },
  {
    id: 34,
    type: "image",
    title: "Curved Front Glass Sweet Counter (Maroon Geometry)",
    category: "Sweet Displays",
    location: "Factory Floor, Jhotwara",
    src: "/gallery/1000202110.jpg",
    desc: "Curved front glass sweet display counter featuring a white lower base styled with maroon diamond geometry patterns.",
    specs: ["Curved Front Glass Profile", "Maroon Diamond Geometry Accent", "Gold Shelf Edge Trims", "Internal Ventilation Grille"]
  }
];
